    ...
    <div className='w-screen h-[60px] bg-gradient-to-r from-secure-blue to-cyan-500 z-10 fixed font-body'>
      ...
      <div className='flex justify-between items-center w-full h-full'>
        ...
        <div className='flex flex-row gap-1'>
          ...
          <button className='hidden md:flex mr-8 cursor-pointer text-back bg-transparent border-cyan-400 border hover:bg-secure-blue hover:text-white hover:border-secure-blue rounded-lg px-4 py-2 text-white'>
